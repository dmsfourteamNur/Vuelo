...
public class ArribarVueloHandler
		implements RequestHandler<ArribarVueloCommand, UUID> {
	...
	@Override
	public UUID handle(ArribarVueloCommand request) throws Exception {
